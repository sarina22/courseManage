...
<html class=" js " style="overflow: scroll;">
<head>
            ...
            <ul class="sidebar-menu">
			  ...
			  <li class="treeview">
                ...
                <ul class="treeview-menu">
                  ...
                  <li><a href="index.php?page=savestudent"><i class="fa fa-angle-right"></i> Add Student </a></li>
                   <li><a href="index.php?page=viewstudent"><i class="fa fa-angle-right"></i> View Students </a></li>
                  
                </ul> 
              </li>

               <li class="treeview">
                <a href="index.php?page=view_all_students">
                <i class="fa fa-dashboard"></i> <span>Student Applications</span>
                </a>
              </li>
               ...
               <li class="treeview">
                <a href="#">
                <i class="fa fa-laptop"></i>
                <span>Manage Module Leader</span>
                <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                
                  <li><a href="index.php?page=savestaff"><i class="fa fa-angle-right"></i> Add Module Leader </a></li>
                   <li><a href="index.php?page=viewstaff"><i class="fa fa-angle-right"></i> View Module Leaders </a></li>
               ...
               <li class="treeview">
                ...
                <ul class="treeview-menu">
                  ...
                  <li><a href="index.php?page=saveadmin"><i class="fa fa-angle-right"></i> Add Admin </a></li>
                   <li><a href="index.php?page=viewadmin"><i class="fa fa-angle-right"></i> View Admins </a></li>
                  
                </ul> 
              </li>
              <li class="treeview">
                <a href="index.php?page=managemodule">
                ...
                <span>Manage Modules</span>
                   ...
                   <li class="treeview">
                <a href="index.php?page=managecourse">
                <i class="fa fa-pie-chart"></i>
